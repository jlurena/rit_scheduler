...
public abstract class BoomButtonBuilder<T> {
    ...
    // View
    ViewGroup innerView;
    @LayoutRes int innerViewRes;
    Rect viewRect = new Rect(Util.dp2px(15), Util.dp2px(52), Util.dp2px(65), Util.dp2px(72));
     ...
     * @return the builder.
     */
    public T addView(@LayoutRes int layoutRes) {
        if (this.innerView == null || layoutRes != innerViewRes) {
            this.innerViewRes = layoutRes;
            BoomButton button = button();
            if (button != null) {
                innerView = button.setInnerView(layoutRes);
            }
        }
        return (T) this;
    }
